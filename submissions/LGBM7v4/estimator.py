...
class FeatureExtractor(BaseEstimator):
    ...
    def transform(self, X):
        ...
        X = compute_rolling_std(X, "Pdyn", "24h", True)
        ...
        # X = compute_rolling_mean(X, "Vth", "1h", True)
        # X = compute_rolling_mean(X, "Vth", "6h", True)
        # X = compute_rolling_mean(X, "Vth", "12h", True)
        # X = compute_rolling_mean(X, "Vth", "24h", True)
        # X = compute_rolling_std(X, "Vth", "1h", True)
        # X = compute_rolling_std(X, "Vth", "6h", True)
        # X = compute_rolling_std(X, "Vth", "12h", True)
